...
const HABITS = [
  { id: 'Japanese', emoji: '📚', label: 'Japanese', defaultDuration: 60, unit: 'minutes', monthlyGoal: 7200 },
  //{ id: 'Writing', emoji: '✍️', label: 'Writing', defaultDuration: 30, unit: 'minutes' },
  { id: 'Programming', emoji: '💻', label: 'Programming', defaultDuration: 60, unit: 'minutes', monthlyGoal: 7200 },
  { id: 'Gym', emoji: '🧘‍♂️', label: 'Workout', defaultDuration: 120, unit: 'minutes' }
];
